...
a persistence unit "ExamenJSPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenJS/pom.xml":
...
artifact ("ExamenJS.war") is already built. You can build
